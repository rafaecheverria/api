    ...
    {
        {
            ...
            $departamentos = [
                ...
                [17,'Dirección nor', 'Direcciòn', 'D',8],
                [18,'Comunicaciones y Asuntos Institucionales nor', 'Com. Asuntos Inst.', 'DCAI',8],
                [19,'Asesoría Jurídica nor', 'As. Jurídica', 'DAJ',8],
                [20,'Planificación y Seguimiento a la  Gestión nor', 'P.S a la Gestiòn', 'DPSG',8],
                [21,'Administración y Servicios Educativos nor', 'Adm. y Serv. Educativos', 'DASE',8],
                [22,'Soporte Tecnológico nor', 'Sop. Tecnológico', 'SP',8],
                [23,'Servicio a Personas nor', 'Serv. Personas', 'DSP',8],
                [24,'Espacios Físicos y Educativos nor', 'Esp. Fis. y Educativos', 'DEFE',8],
                [25,'Cobertura y Proyectos nor', 'Cob. y Proyectos', 'DCP',8],
                [26,'Administración y Finanzas nor', 'Adm. y Finanzas', 'DAF',8],
                [27,'Reconocimiento Oficial nor', 'Rec. Oficial', 'DRO',8],
                [28,'Área de Calidad Educativa nor', 'A. Cal. Educativa', 'DACE',8],
                [29,'Asesoría Técnica Regional nor', 'As. Téc. Regional', 'DATR',8],
                [30,'Desarrollo de Personas y Equipos nor', 'Des. de Per. y Equipos', 'DPE',8],
                [31,'Promoción y Protección de la Infancia nor', 'Prom. y Prot. de la Infancia', 'PPI',8],
                [32,'Departamento de Educación nor', 'Dep. Educaciòn', 'DE',8],
            ];
